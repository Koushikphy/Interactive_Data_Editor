  ...
  describe('MergedCellsCollection', function () {
    ...
    describe('`add` method', function () {
      it('should add a merged cell object to the array of merged cells', function () {
        var mergedCellsCollection = new _cellsCollection.default({
          hot: hotMock
        });
      ...
      it('should not add new merged cells and throw an appropriate warning, if the merged cell is overlapping any other ' + 'previously declared merged cell', function () {
        ...
        expect(warnSpy).toHaveBeenCalledWith(_cellsCollection.default.IS_OVERLAPPING_WARNING(newMergedCells[1]));
    ...
    describe('`isOverlapping` method', function () {
      it('should return whether the provided merged cell overlaps with the others in the merged cell', function () {
        ...
        expect(mergedCellsCollection.isOverlapping({
          row: 30,
          col: 30,
          rowspan: 3,
          colspan: 3
